...
public class PoleTrojkataProstokatnegoActivity extends AppCompatActivity {
    Button guzik;
    EditText bok1;
    EditText bok2;
    TextView wynik;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pole_trojkata_prostokatnego);
        ...
        bok1.setHint("Podaj dlugosc pierwszej przyprostokatnej");
        bok2.setHint("Podaj dlugosc drugiej przyprostokatnej");
